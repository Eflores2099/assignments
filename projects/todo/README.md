...
1. UI Toolkit with 40+ Web Components. 
2. Custom Elements Framework similar to Polymer, LitElement and X-TAG. It supports two-way data-binding, templates, property change notifications, Typescript-like type-checking and validation.
...
*   ### The SDK files are located in the "smart" directory
    ...
    *   smart.element.js:  Framework. You can use this for Custom Elements development.
    *   smart.core.js: All Custom Elements.
    *   smart.default.css: Stylesheet for all Custom Elements.
